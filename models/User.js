...
const userSchema = new mongoose.Schema({
  ...
  // Google OAuth ID (sub claim). When present, password may be auto-generated random.
  googleId: {
    type: String,
    index: true,
    sparse: true,
  ...
  whatsappOptIn: {
    type: Boolean,
    default: false // Explicit user consent required for marketing messages; index removed (we add global index below)
  },
...
// Removed duplicate whatsappOptIn inline index; single index defined below if needed
