...
const categorySchema = new mongoose.Schema({
  ...
  image: {
    type: String,
  // Make optional; we'll fallback to a product image or a default placeholder at response time
  default: ''
  },
  slug: {
    type: String,
    lowercase: true // unique handled by index definition below (collation aware)
  },
  isActive: {
    type: Boolean,
    default: true
